...
<br>__*На виртуальной машине развернул кластер Postgres версии 15. Создал базу данных testdb. В новой БД создал схему pract_functions, а в ней уже создал таблицы  goods   (товары), sales (продажи) и витрину good_sum_mart.*__
