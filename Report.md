...
По заданию нужно создать витрину good_sum_mart (сумма продаж по каждому товару).*__
<br>__*Создать триггер на таблице продаж, для поддержки данных в витрине в актуальном состоянии (вычисляющий при каждой продаже сумму и записывающий её в витрину)*__ 
